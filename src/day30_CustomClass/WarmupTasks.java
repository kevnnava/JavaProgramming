...
public class WarmupTasks {
    ...
    public static void main(String[] args) {
        ...
        letters.removeIf(p -> !Character.isLetter(p) ); // Lambda, removes all the characters that are not letters

        System.out.println("letters = " + letters);

        ArrayList<Character> digits = new ArrayList<>(chars); // add all of the characters
        digits.removeIf(p -> !Character.isDigit(p) ); // removes all the characters that are not digits
        ...
        // specialChar.removeIf(p -> Character.isLetterOrDigit(p) ); another method
